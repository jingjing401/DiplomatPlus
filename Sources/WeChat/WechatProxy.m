...
@property (copy, nonatomic) NSString *wechatUniversalLink;
...
- (void)registerWithConfiguration:(NSDictionary * __nonnull)configuration
{
    ...
    self.wechatUniversalLink = configuration[kDiplomatAppUniversalLinkKey];
    [WXApi registerApp:self.wechatAppId universalLink:self.wechatUniversalLink];
}

- (void)authWithViewController:(UIViewController *)viewController completedBlock:(DiplomatCompletedBlock)completedBlock {
    ...
    [WXApi sendAuthReq:request viewController:viewController delegate:self completion:nil];
}
...
- (void)share:(DTMessage * __nonnull)message completed:(DiplomatCompletedBlock __nullable)compltetedBlock
{
  ...
  if (message.userInfo)
  {
    ...
    [WXApi sendReq:wxReq completion:nil];
...
- (void)pay:(id<DTWechatPaymentOrder> __nonnull)order completed:(DiplomatCompletedBlock __nullable)completedBlock
{
    ...
    [WXApi sendReq:payReq completion:nil];
}
